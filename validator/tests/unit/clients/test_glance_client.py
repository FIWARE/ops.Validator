...
#  under the License.
"""Tests for validator.clients.glance_client """
from __future__ import unicode_literals
import mock
from oslo_config import cfg
from validator.clients.glance_client import AmbiguousNameException
from validator.clients.glance_client import GlanceClient
from validator.tests.unit.base import ValidatorTestCase

CONF = cfg.CONF
CONF.import_group('clients_glance', 'validator.clients.glance_client')
